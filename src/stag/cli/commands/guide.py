...
```bash
stag git attach --output-transition <ot_id> --commit <sha> [--commit <sha> ...]
...
stag git attach --output-transition ot_0001 --commit abc123 --commit def456
# -> ot_0001 に GitChangePayload を attach
```
...
stag git attach --output-transition ot_0001 --commit abc123 --commit def456
# -> attaches a GitChangePayload to ot_0001
```
