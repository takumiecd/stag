#!/usr/bin/env python3
"""Smoke test: optimize a real Python file using OpenCode backend."""
...
# Use user's opencode path
adapter = OpenCodeBackendAdapter(command="/home/ware10sai/.opencode/bin/opencode")
opt = CodeOptimizer(
    source_path=source,
    backend=adapter,
    work_dir=work_dir,
